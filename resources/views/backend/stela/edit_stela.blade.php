        ...
        <div class="overflow-hidden shadow-none card bg-light-info position-relative">
            <div class="px-4 py-3 card-body">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="mb-8 fw-semibold">Edit STELA</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Edit Stela</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-3">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5>STELA Form</h5>
                        <form class="form-horizontal r-separator" method="POST" action="{{ route('update.stela') }}">
                            @csrf
                            <input type="hidden" name="id" value="{{ $stela->id }}">
                            <div class="card-body">
                                        ...
                                        <select name="petugas" class="select2 form-control"
                                            ...
                                            @foreach ($pegawai as $item)
                                                <option value="{{ $item['nama'] }}"
                                                    {{ $item['nama'] == $stela->petugas ? 'selected' : '' }}>
                                                    {{ $item['nama'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="mb-0 form-group row align-items-center">
                                    ...
                                    <div class="pt-2 pb-2 col-9 border-start">
                                        <input type="text" class="form-control text-capitalize" name="nama_ibu"
                                            id="nama_ibu" value="{{ $stela->nama_ibu }}" />
                                    </div>
                                </div>
                                <div class="mb-0 form-group row align-items-center">
                                    ...
                                    <div class="pt-2 pb-2 col-9 border-start">
                                        <input type="text" class="form-control text-capitalize" name="nama_ayah"
                                            id="nama_ayah" value="{{ $stela->nama_ayah }}" />
                                    </div>
                                </div>
                                <div class="mb-0 form-group row align-items-center">
                                ...
                                <div class="mb-0 form-group row align-items-center">
                                    ...
                                    <div class="pt-2 pb-2 col-9 border-start">
                                        <input type="text" class="form-control text-capitalize" name="nama_anak"
                                            id="nama_anak" value="{{ $stela->nama_anak }}" />
                                    </div>
                                </div>
                                <div class="mb-0 form-group row align-items-center">
                                    ...
                                    <div class="pt-2 pb-2 col-9 border-start">
                                        <div class="form-check">
                                            <input name="jenis_kelamin" type="radio" class="form-check-input"
                                                value="laki-laki" name="radio-stacked"
                                                {{ $stela->jenis_kelamin == 'Laki-Laki' ? 'checked' : '' }} />
                                            <label class="form-check-label" for="laki">Laki-Laki</label>
                                        </div>
                                        <div class="form-check">
                                            <input name="jenis_kelamin" type="radio" class="form-check-input"
                                                value="perempuan" name="radio-stacked"
                                                {{ $stela->jenis_kelamin == 'Perempuan' ? 'checked' : '' }} />
